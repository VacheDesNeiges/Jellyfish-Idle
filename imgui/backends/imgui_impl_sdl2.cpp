...
//  ImGuiPlatformIO interface. 2023-04-06: Inputs: Avoid calling
...
#define MAP_BUTTON(KEY_NO, BUTTON_NO)                                         \
  {                                                                           \
    io.AddKeyEvent (KEY_NO,                                                   \
                    SDL_GameControllerGetButton (game_controller, BUTTON_NO)  \
                        != 0);                                                \
  }
#define MAP_ANALOG(KEY_NO, AXIS_NO, V0, V1)                                   \
  ...
  MAP_ANALOG (ImGuiKey_GamepadL2, SDL_CONTROLLER_AXIS_TRIGGERLEFT, 0.0f,
              32767);
  MAP_ANALOG (ImGuiKey_GamepadR2, SDL_CONTROLLER_AXIS_TRIGGERRIGHT, 0.0f,
              32767);
