...
// CHANGELOG
//  2024-05-14: *BREAKING CHANGE* ImGui_ImplSDLRenderer3_RenderDrawData()
//  requires SDL_Renderer* passed as parameter. 2023-05-30: Renamed
...
void ImGui_ImplSDLRenderer2_NewFrame()
{
    ...
    IM_ASSERT(bd != nullptr && "Context or backend not initialized! Did you "
                               "call ImGui_ImplSDLRenderer2_Init()?");
...
bool ImGui_ImplSDLRenderer2_CreateFontsTexture()
{
    ...
    bd->FontTexture =
        SDL_CreateTexture(bd->Renderer, SDL_PIXELFORMAT_ABGR8888,
