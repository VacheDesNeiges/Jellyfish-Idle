...
void UIAbilitiesPanel::render() const
{
...
void UIAbilitiesPanel::renderAbilityButton(AbilityType ability) const
{
...
void UIAbilitiesPanel::setToolTip(AbilityType ability) const
{
