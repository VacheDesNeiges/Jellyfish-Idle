...
enum ImGuiInputFlags_
{
  ...
  = 1 << 11, // Register route globally (highest priority: unlikely you need to
             // use that: will interfere with every active items)
  ...
  = 1 << 13, // Global routes will not be applied if underlying background/void
...
// - Route is granted to a single owner. When multiple requests are made we
// have policies to select the winning route.
