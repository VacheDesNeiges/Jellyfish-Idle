...
// imgui/ repository into your project (either as a copy or as a submodule),
// and only build the backends you need. Learn about Dear ImGui:
...
//  imgui_impl_sdlrenderer2.h/.cpp to accommodate for upcoming SDL3.
          ...
          if (pcmd->UserCallback)
          ...
          else
            {
              ...
              const SDL_Color *color
                  = (const SDL_Color
                         *)(const void *)((const char *)(vtx_buffer
                                                         + pcmd->VtxOffset)
...
ImGui_ImplSDLRenderer2_CreateFontsTexture ()
{
  ...
  bd->FontTexture
      = SDL_CreateTexture (bd->SDLRenderer, SDL_PIXELFORMAT_ABGR8888,
