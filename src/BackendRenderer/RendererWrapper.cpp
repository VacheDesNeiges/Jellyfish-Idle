...
void
RendererWrapper::initializeImgui ()
{
  IMGUI_CHECKVERSION ();
  ImGui::CreateContext ();
  io = &ImGui::GetIO ();
...
void
RendererWrapper::startRenderingNewFrame () const
{
...
void
RendererWrapper::finalizeRenderingNewFrame ()
{
  ImGui::Render ();
...
bool
RendererWrapper::processEvent (const SDL_Event &event)
{
